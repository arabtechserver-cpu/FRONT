            ...
            {filteredCustomers.length === 0 ? (
              ...
              paginatedCustomers.map((customer) => (
                <tr key={customer.id}>
                  ...
                  <td data-label="كلمة المرور" style={{ color: customer.password_masked === 'مسجل بجوجل' ? '#60a5fa' : '#94a3b8', fontWeight: 700 }}>
                    {customer.password_masked === 'مسجل بجوجل' ? (
                      <span style={{ display: 'inline-block', padding: '4px 8px', background: 'rgba(59, 130, 246, 0.15)', borderRadius: '6px', fontSize: '0.85rem' }}>
                        تسجيل جوجل
                      </span>
                    ) : (
                      customer.password_masked || "مخفية"
                    )}
                  </td>
