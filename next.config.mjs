...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
  {
    ...
    value: [
      ...
      `img-src 'self' data: blob: ${apiUrl} https://api.al-wefaq.center https://sk-unlocker.com https://* http://* https://lh3.googleusercontent.com https://ssl.gstatic.com https://*.googleusercontent.com`,
      `media-src 'self' data: blob: ${apiUrl} https://api.al-wefaq.center https://sk-unlocker.com`,
      `connect-src 'self' ${apiUrl} https://api.al-wefaq.center https://sk-unlocker.com https://www.paypal.com https://*.paypal.com https://challenges.cloudflare.com https://accounts.google.com https://*.google.com https://identitytoolkit.googleapis.com https://v6.exchangerate-api.com`,
